	...
	return (
		<Section>
			...
			<FAQitem question="Mikä ihmeen Evon Capital?">
				Monipuolinen sijoitusyhtiö, joka koostuu yli 160 omistajasta. Sijoitamme
				niin liostaamattomille markkinoille kuin pörssiinkin.
			</FAQitem>
			<FAQitem question="Mihin Evon Capital sijoittaa?">
				Vuoden 2023 tavoitteena on listaamattomien arvopaperien painon
				merkittävä lisääminen. Samalla yhtiön profiilin nostaminen
				listaamattoman markkinan toimijana.
			</FAQitem>
			<FAQitem question="Mistä yritysjohto koostuu?">
				Yhtiöjohto koostuu omistajistamme. Evon Capital on yhteisö ja tämä
				yhteisö pyörittää itseään.
			</FAQitem>
			...
			<FAQitem question="Miksi keräätte jatkuvasti uutta pääomaa?">
				...
				meille oleellista, sillä se luo uusia mahdollisuuksia. Yksittäisten

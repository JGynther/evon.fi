      ...
      <Section>
        {didSubmit ? (
          ...
          <>
            ...
            <Prose large>
              Voit tehdä merkinnän osakeantiin täyttämällä oheisen lomakkeen.
              Täytä erityisesti tietosi hyvin huolellisesti. Epämääräiset tai
              virheelliset tiedot johtavat merkinnän hylkäämiseen. Merkintä on
              sitova, eikä sitä voi perua.
            </Prose>
            <Form
            ...
            >
              ...
              <div className="bg-rose-500 bg-opacity-20 rounded p-5 my-4">
                <b>Huom!</b>
                <p className="mt-2">
                  Merkintä on sitova eikä sitä voi perua. Tutustu annin
                  ehtoihin. Ymmärrä sijoitukseen liittyvät riskit.
                </p>
